...
public class VectorHelper {
    public static int [] Somme (int [] Tab1, int []Tab2){/**Fonction qui fait la somme des valeurs de deux tableaux en entr�e et retourne le tableau resultatant**/
    	int[] Tab=null;/** Declarer un tableau vide **/
    try{	
    	if (Tab1.length==Tab2.length){   /** Le cas d'egalit� de longeur des tables **/
    ...
    public static int[] inverse(int Tab[]){/**une fonction qui donne en sortie un tableau inverser de celui en entr�e**/
    	int k2=Tab.length-1; /**Affecter l'indice du dernier element du tableau en entr�e a une variable**/
    	...
    	for (int k1=0;k1<=kmid;k1++){/**Une boucle qui varie entre le debut et le millieu du tableau en entr�e**/
    		...
    		Tab[k2]=val;/**affecter la valeur de val dans la case deja permut�e**/
    		k2--;/**d�crementer pour passer au prochain element a permuter avec l'element de la case Tab[k1] avec k1 qui va etre increment� a l'aide de la boucle for **/
    ...
    public static int [] formule(int Tab[],char c,int k){/**une fonction qui donne en sortie un tableau dont la formule c ,par la valeur k ,est realis�
